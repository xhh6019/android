...
def BuildBootableImage(sourcedir, pagesize):
  ...
  if pagesize == "2048": 
  	fn = os.path.join(sourcedir, "2kpagesize")
  else:
...
def GetBootableImage(name, prebuilt_name, unpack_dir, tree_subdir, pagesize):
  ...
  if os.path.exists(prebuilt_path):
    ...
    return File(name, BuildBootableImage(os.path.join(unpack_dir, tree_subdir), pagesize))
